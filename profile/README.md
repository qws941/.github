...
| Repository | Description | Stack |
| ---------- | ----------- | ----- |
| claude | Claude AI experiments | Shell |
| propose | Proposal management tool | TypeScript |
| safework2 | SafeWork platform v2 | TypeScript |
...
- **Trunk-based development** with squash merge only
